...
y_pred_normal, confidence = model.predict(
    X = X_test,
    k = 9, # Change this value to get the top k predictions
)

# Predict anomalous data using the baseline model
y_pred_anomaly, confidence = model.predict(
    X = X_test_anomaly,
    k = 9, # Change this value to get the top k predictions
)
